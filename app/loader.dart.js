...
$$.Application = {"": "Object;env<,context",
  start$0: function(_) {
    var contexts = $.queryAll$1$x(this.context, ".Octopi-context");
    contexts.every$1(contexts, new $.Application_start_anon(this));
  }
};

$$.Application_start_anon = {"": "Closure;this_0",
  call$1: function(i) {
    var t1, t2, t3, doodad;
    t1 = $.getInterceptor$x(i);
    t2 = t1.get$attributes(i);
    t3 = this.this_0.get$env().classifiers;
    doodad = t3.$index(t3, t2.$index(t2, "data-octopi-context")).call$1(i);
    t2 = t1.get$classes(i);
    if (t2.contains$1(t2, "persistent"))
      doodad.enable_persistence$0();
    t1.append$1(i, doodad.make$0());
  }
};

$$.Doodad = {"": "Marionette;",
  make$0: function() {
    return $._ElementFactoryProvider_createElement_html("<span>[" + this.singular + " placeholder]</span>");
  },
  enable_persistence$0: function() {
    this.persistent = true;
  }
};

$$.Environment = {"": "Object;assets,classifiers,templatecache"};

$$.Marionette = {"": "Object;",
  Marionette$2: function(singular, plural, plural_check) {
    if (plural_check === true)
      this.plural = this.singular + "s";
  }
};

$$.Todo = {"": "Doodad;name,group,entrypoint,persistent,singular,plural"};

$$.TodoList = {"": "Doodad;name,group,entrypoint,persistent,singular,plural"};
...
$$._HashTable = {"": "Object;",
  ...
  _checkCapacity$0$bailout: function(state0, t1, freeCount, t2) {
    switch (state0) {
      case 0:
        t1 = this._capacity;
      case 1:
      ...
      case 2:
        state0 = 0;
        if ($.JSNumber_methods.$lt(t1, t2) || freeCount < this._deletedCount)
...
$$._FrozenElementListIterator = {"": "Object;_list,_index,_current",
  moveNext$0: function() {
    var nextIndex, t1;
    nextIndex = $.$add$ns(this._index, 1);
    t1 = this._list;
...
$.static_assets = function(keys) {
};

$.main = function() {
  var app = $.Application$from($.Environment$from($.static_assets, $.makeLiteralMap(["TodoList", new $.main_anon(), "Todo", new $.main_anon0()])), $.query$1$x(document, "body"));
  app.start$0(app);
};

$.Application$from = function(env, context) {
  return new $.Application(env, context);
};

$.Environment$from = function(assets, classifiers) {
  return new $.Environment(assets, classifiers, null);
};

$.Todo$ = function(entrypoint) {
  var t1 = new $.Todo(null, null, entrypoint, null, "todo", null);
  t1.Marionette$2("todo", null, true);
  return t1;
};

$.TodoList$ = function(entrypoint) {
  var t1 = new $.TodoList(null, null, entrypoint, null, "todo list", null);
  t1.Marionette$2("todo list", null, true);
  return t1;
};
...
$.static_assets.call$1 = $.static_assets;
$.static_assets.$name = "static_assets";
$.$$throw.call$1 = $.$$throw;
$.$$throw.$name = "$$throw";
...
$.$defineNativeClass("Element", {"": "$$dom_children:children=,innerHtml:innerHTML},tagName=",
...
//@ sourceMappingURL=loader.dart.js.map
